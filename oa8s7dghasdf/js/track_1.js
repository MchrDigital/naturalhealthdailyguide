	...
	// Save sessid2 cookie
	document.cookie = "sessid2="+escape("sessid20260917142915874")+";expires="+spiexpire.toGMTString()+";path=/;domain=."+hostname;

	// Save funnel cookies
	document.cookie = "spi_funnel_codename="+escape("")+";expires="+spiexpire.toGMTString()+";path=/;domain=."+hostname;
				
						document.cookie = "sid="+escape("pagameric")+";expires="+spiexpire.toGMTString()+";path=/;domain="+hostname;
						
	document.cookie = "referrer="+("2a00:b703:fff1:102::1::www.forcecore.site%2Fjr1")+";expires="+spiexpire.toGMTString()+";path=/;domain="+hostname;
	...
	var spi_replace_str_bg = spi_pattern_base_bg+"sessid2="+escape("sessid20260917142915874")+"&";
	...
	var spi_replace_str_bg_html = spi_pattern_base_bg_html+"sessid2="+escape("sessid20260917142915874")+"&";
	...
	var spi_replace_str_bg_html2 = spi_pattern_base_bg_html2+"sessid2="+escape("sessid20260917142915874")+"&";
	...
	var spi_replace_str_bg_html3 = spi_pattern_base_bg_html3+"sessid2="+escape("sessid20260917142915874")+"&";
	...
	var spi_replace_str_bg_html4 = spi_pattern_base_bg_html4+"sessid2="+escape("sessid20260917142915874")+"&";

	var spi_pattern_enc_spi = "softwareprojects.com%2Fsecure%2F%3F";
	var spi_pattern_base_spi = "softwareprojects.com/secure/?";
	var spi_replace_str_spi = spi_pattern_base_spi+"sessid2="+escape("sessid20260917142915874")+"&";

	var spi_pattern_enc_cbd = "buygoodshomeoils.com%2Fsecure%2F%3F";
	var spi_pattern_base_cbd = "buygoodshomeoils.com/secure/?";
	var spi_replace_str_cbd = spi_pattern_base_cbd+"sessid2="+escape("sessid20260917142915874")+"&";
	...
	var spi_replace_str_cbd_html = spi_pattern_base_cbd_html+"sessid2="+escape("sessid20260917142915874")+"&";
				

spi_replace_str_cbd = spi_replace_str_cbd+'sid=pagameric&';spi_replace_str_cbd_html = spi_replace_str_cbd_html+'sid=pagameric&';spi_replace_str_bg = spi_replace_str_bg+'sid=pagameric&';spi_replace_str_spi = spi_replace_str_spi+'sid=pagameric&';spi_replace_str_bg_html = spi_replace_str_bg_html+'sid=pagameric&';spi_replace_str_bg_html2 = spi_replace_str_bg_html2+'sid=pagameric&';spi_replace_str_bg_html3 = spi_replace_str_bg_html3+'sid=pagameric&';spi_replace_str_bg_html4 = spi_replace_str_bg_html4+'sid=pagameric&';
