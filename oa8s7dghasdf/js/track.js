...
var initialSrc = "https://trk.forcecore.site/" + campaignID + "?format=json";
...
function fixHrefWithClick(
    ...
    document.querySelectorAll('a').forEach(function (el) {
        if (el.href.indexOf("trk.forcecore.site/click") > -1) {
    ...
    if (!urlParams.get('rtkcid')) {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                xhrr.open("GET", "https://trk.forcecore.site/view?clickid=" + rawData.clickid)
                xhrr.send();
            }
        }
        ...
        xhrTrack.open("GET", "https://trk.forcecore.site/view?clickid=" + rtkClickID)
        xhrTrack.send();
        ...
        const interval = setInterval(() => {
            try {
                ...
                if ((fbp || fbc) && clickId) {
                    ...
                    const url = new URL('https://trk.forcecore.site/clickupd/' + clickId)
